...
-- Records of courses
-- ----------------------------
INSERT INTO `courses` VALUES ('1', '篮球', '500');
INSERT INTO `courses` VALUES ('2', '羽毛球', '20');
INSERT INTO `courses` VALUES ('3', '游泳', '203');
INSERT INTO `courses` VALUES ('4', '乒乓球', '20');
INSERT INTO `courses` VALUES ('5', '足球', '10');
...
CREATE TABLE `players` (
  `id` int NOT NULL AUTO_INCREMENT,
  `displayNameEn` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `displayName` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `countryEn` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `country` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `draftYear` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `height` double DEFAULT NULL,
  `weight` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  ...
  `teamCity` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `teamName_id` int DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `teamName_id` (`teamName_id`) USING BTREE,
...
-- Records of students
-- ----------------------------
INSERT INTO `students` VALUES ('1', 'wang', '18');
INSERT INTO `students` VALUES ('2', 'tom', '45');
INSERT INTO `students` VALUES ('3', 'lily', '25');
INSERT INTO `students` VALUES ('4', 'rong', '18');
INSERT INTO `students` VALUES ('5', 'yang', '20');
...
INSERT INTO `students_select_courses` VALUES ('4', '2', '4');
INSERT INTO `students_select_courses` VALUES ('5', '3', '1');
INSERT INTO `students_select_courses` VALUES ('6', '3', '2');
INSERT INTO `students_select_courses` VALUES ('7', '4', '4');
...
CREATE TABLE `teams` (
  `id` int NOT NULL AUTO_INCREMENT,
  `teamName` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `teamNameEn` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `teamCity` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `teamCityEn` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `displayConference` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `division` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE `user` (
  ...
  `age` int DEFAULT '0',
  `telPhone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `createTime` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updateTime` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `phoneNum` (`telPhone`) USING BTREE
